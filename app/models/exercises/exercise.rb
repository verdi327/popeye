class Exercise < ActiveRecord::Base
  ...
  validates :reps, presence: {message: "number of reps is required" }, numericality: { only_integer: true, greater_than: 0, message: "reps: only whole, positive numbers" }, unless: Proc.new {|exercise| exercise.time_rep? || exercise.pyramid_rep?}
